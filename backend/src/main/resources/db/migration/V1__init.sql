...
CREATE TABLE IF NOT EXISTS users (
    ...
    role         VARCHAR(20)  NOT NULL DEFAULT 'OWNER' COMMENT '角色',
...
CREATE TABLE IF NOT EXISTS pets (
    ...
    species       VARCHAR(20)   NOT NULL                COMMENT '品种：CAT, DOG, OTHER',
...
CREATE TABLE IF NOT EXISTS feeders (
    ...
    certification VARCHAR(1000) DEFAULT NULL            COMMENT '资质证书URL',
    status        VARCHAR(20)   NOT NULL DEFAULT 'PENDING' COMMENT '审核状态',
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    service_period VARCHAR(10)   NOT NULL               COMMENT '服务时段',
...
CREATE TABLE IF NOT EXISTS sms_logs (
    ...
    feeder_id  BIGINT        DEFAULT NULL           COMMENT '关联喂养员ID',
    phone      VARCHAR(20)   DEFAULT NULL           COMMENT '手机号',
